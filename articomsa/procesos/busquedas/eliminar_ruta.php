...
<?php
	...
	mysqli_select_db($con, $nombre_bd)
		...
		$actualizar = "DELETE FROM ruta WHERE id_ruta='$_POST[id_ruta]'" ;
			...
			header ('location: ../../vistas/vistas/ruta_eliminada.php');
	...
	echo "<table>
		...
		echo "<form action=eliminar_ruta.php method=post name=eliminar_ruta>";
		echo"<tr>";
		echo"<td align=center>".$data['id_ruta']." </td>";
		echo"<td>"."<input type=text name= descripcion disabled value='".$data['descripcion']."' </td>";
