...
<form action="../../procesos/registros/registrar_presentacion.php" method="post" name="form_registrar_presentacion"><br>
	<fieldset>
		<legend class="leyenda"> Nueva Presentacion </legend>
		<div id="formulario">
		<br><br>
		<label>Nombre para Presentacion*: </label> <input type="text" name="p_nombre"/><br><br>
